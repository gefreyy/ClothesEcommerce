...
export default function Header({setSearchTerm}) {
    ...
    return (
        <header id='header-section'>
            ...
            <button onClick={toggleMenu} className='hamburguer-button'><img src="/public/img/hamburguer-menu-icon.png" alt="hamburguer-button-icon" /></button>
            <div className={isMenuOpen ? 'lateral-menu open' : 'lateral-menu'}>
                <div className="menu-top">
                    <h1>Fortnite Shop</h1>
                    <button className='close-btn' onClick={toggleMenu}><img src="/public/img/close-icon.png" alt="close-icon" /></button>
                </div>
                <ul>
            ...
            <a href="#"><img className='logo-img' src="/public/img/lorem-lorem.svg" alt="logo-shop" /></a>
            ...
            <div className="options-icons">
                ...
                <button onClick={toggleSearch} className={isSearchOpen ? 'button-search show' : 'button-search hide'}><img src="/public/img/search-icon.png" alt="search-icon" /></button>
                ...
                <Link to="/login" className='icon-header'><img src="/public/img/user-icon.png" alt="user-icon" /></Link>
                <Link href='#' className='icon-header'><img src="/public/img/shopping-cart-icon.png" alt="shopping-cart-icon" /></Link>
            </div>
        </header>
    )
}